using RegulusWeb.Common;
using RegulusWeb.Domain.Abstract;
using RegulusWeb.Models;
using System;
using System.Web.Mvc;

namespace RegulusWeb.Controllers
{
    public class AccountController : Controller
    {
        ...
        public ActionResult Login(UserModel objmodel)
        {
            ...
            {
                RegulusWeb.Domain.Entity.User objentity = new Domain.Entity.User();
                ...
                objentity.DOB = DateTime.ParseExact(objmodel.DOB.Replace('.','/'),"dd/MM/yyyy",null);
